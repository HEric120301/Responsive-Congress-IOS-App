...
class CommSenateController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CommSenateCell", for: indexPath) as! CommSenateCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "CommSenateDetail", sender: indexPath)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationDT = segue.destination as? CommSenateDetail {
...
//search
extension CommSenateController: UISearchResultsUpdating {
    @available(iOS 8.0, *)
