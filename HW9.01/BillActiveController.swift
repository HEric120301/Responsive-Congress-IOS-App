...
class BillActiveController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let parameters: Parameters = ["action": 2]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "BillActiveCell", for: indexPath) as! BillActiveCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "BillActiveDetail", sender: indexPath)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationDT = segue.destination as? BillActiveDetail {
...
//search
extension BillActiveController: UISearchResultsUpdating {
    @available(iOS 8.0, *)
