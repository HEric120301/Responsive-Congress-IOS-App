...
class FavCommController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //retrieve data
        if let resData:[AnyObject] = GlobalFav.CommFav as [AnyObject]? {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FavCommCell", for: indexPath) as! FavCommCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "FavCommDetail", sender: indexPath)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationDT = segue.destination as? FavCommDetail {
...
//search
extension FavCommController: UISearchResultsUpdating {
    @available(iOS 8.0, *)
