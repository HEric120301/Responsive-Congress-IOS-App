//
//  LegiSenateTableViewController.swift
//  HW9.01
//
...
class LegiSenateTableViewController: UIViewController, UISearchBarDelegate, UISearchDisplayDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellSenate", for: indexPath) as! LegiSenateTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "senateDetail", sender: indexPath)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if searchController.isActive && searchController.searchBar.text != "" {
            ...
            if let destinationDT = segue.destination as? LegiSenateDetail {
...
extension LegiSenateTableViewController: UISearchResultsUpdating {
    @available(iOS 8.0, *)
