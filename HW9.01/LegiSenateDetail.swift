...
class LegiSenateDetail: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for temp in GlobalFav.LegiFav {
            if temp["bioguide_id"] as? String! == bioid {
                isfav = true
                break
            }
        }
