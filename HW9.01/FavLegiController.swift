...
class FavLegiController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //retrieve data
        if let resData:[AnyObject] = GlobalFav.LegiFav as [AnyObject]? {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FavLegiCell", for: indexPath) as! FavLegiCell
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "FavLegiDetail", sender: indexPath)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationDT = segue.destination as? FavLegiDetail {
...
//search
extension FavLegiController: UISearchResultsUpdating {
    @available(iOS 8.0, *)
